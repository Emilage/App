(function () {
            ...
            if (index != null) {
                ...
                if (typeof (index) === "number") {
                    if (Data.items._groupedItems[index] != undefined) {
                        if (Data.items._groupedItems[index].data.recordType === RecordType.bigger) {
                            size.width = 695;
                            size.height = 525
                        }
                        else if (Data.items._groupedItems[index].data.recordType === RecordType.big) {
                            size.width = 576;
                            size.height = 345;
                        }
    ...
    function sendTileLocalImageNotification() {
        ...
        tileTextAttributes[0].innerText = "Travel Dark Theme";
