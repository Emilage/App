    ...
    public sealed class HubPageDataSource
    {
        ...
        public HubPageDataSource()
        {
            ...
            var group1 = new HubPageDataGroup("Group-1",
                    ...
                    "Group Description: This is a religious app");
            group1.Items.Add(new HubPageDataItem("Big-Group-1-Item-1",
                    "Pocket Bible",
                    "World English Bible",
                    "Assets/Images/HubPage/OpenBible.jpg",
                    "Item Description:, Hello God.",
                    ITEM_CONTENT,70,54,
                    group1));
            group1.Items.Add(new HubPageDataItem("Small-Group-1-Item-2",
                     "Prayers",
                    "Litle Book of Prayers",
                    "Assets/Images/HubPage/Payers.jpg",
            ...
            group1.Items.Add(new HubPageDataItem("Small-Group-1-Item-3",
                    "Mass Reading",
                    "Reading of the Day",
                    "Assets/Images/HubPage/Chalice.jpe",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT, 18, 18,
                    group1));
            ...
            group2.Items.Add(new HubPageDataItem("Medium-Group-2-Item-1",
                    ...
                    "Assets/Images/HubPage/jesusPraying.jpg",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT, 36, 36,
                    group2));
            group2.Items.Add(new HubPageDataItem("Small-Group-2-Item-2",
                   "Saint of the Day",
                    "Today's Saint",
                    "Assets/Images/HubPage/candles.jpg",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT, 18, 18,
                    group2));
            group2.Items.Add(new HubPageDataItem("Small-Group-2-Item-3",
                    "Prayer of the Week",
                    "This Week's Prayer",
                    "Assets/Images/HubPage/rosary.jpg",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT, 18, 18,
                    group2));
            ...
            group4.Items.Add(new HubPageDataItem("Small-Group-4-Item-1",
                  "The Commandments",
                    ...
                    "Assets/Images/HubPage/tenComm.jpg",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT, 18, 18,
                    group4));
            group4.Items.Add(new HubPageDataItem("Small-Group-4-Item-2",
                    "Passage of the Day",
                    "Daily Passages",
                    "Assets/Images/HubPage/passage.jpe",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT, 18, 18,
                    group4));
            group4.Items.Add(new HubPageDataItem("Small-Group-4-Item-3",
                    ...
                    "Assets/Images/HubPage/vatican.jpg",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT, 18, 18,
                    group4));
            group4.Items.Add(new HubPageDataItem("Wide-Group-4-Item-4",
                   "The Pope",
                    "Information on the Pope",
                    "Assets/Images/HubPage/pope.jpg",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT, 54, 36,
                    group4));
            group4.Items.Add(new HubPageDataItem("Small-Group-4-Item-5",
                   "Holy Days",
                    ...
                    "Assets/Images/HubPage/easterHolyDay.jpe",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT, 18, 18,
                    group4));
            group4.Items.Add(new HubPageDataItem("Small-Group-4-Item-6",
                   "Hymns",
                    "Hymn of the Day",
                    "Assets/Images/HubPage/hymnSheet.jpe",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT, 18, 18,
                    group4));
            group4.Items.Add(new HubPageDataItem("Small-Group-4-Item-6",
                   "Church Hymns",
                    "List of Hymns",
                    "Assets/Images/HubPage/churchHymns.jpe",
                   "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                   ITEM_CONTENT, 18, 18,
                   group4));
