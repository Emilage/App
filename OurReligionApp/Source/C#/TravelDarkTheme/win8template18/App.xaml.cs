...
using TravelDarkTheme.SettingsFlyouts;
...
namespace TravelDarkTheme
{
    ...
    sealed partial class App : Application
    {
        ...
        void App_CommandsRequested(SettingsPane sender, SettingsPaneCommandsRequestedEventArgs args)
        {
            ...
            SettingsCommand ContactUs = new SettingsCommand("CU", "Contact Us", handler);
        ...
        protected async override void OnSearchActivated(Windows.ApplicationModel.Activation.SearchActivatedEventArgs args)
        {
            ...
            if (frame == null)
            {
                ...
                frame = new Frame();
                TravelDarkTheme.Common.SuspensionManager.RegisterFrame(frame, "AppFrame");
                ...
                if (args.PreviousExecutionState == ApplicationExecutionState.Terminated)
                {
                    ...
                    try
                    {
                        await TravelDarkTheme.Common.SuspensionManager.RestoreAsync();
                    }
                    catch (TravelDarkTheme.Common.SuspensionManagerException)
                    {
                        //Something went wrong restoring state.
                        //Assume there is no state and continue
                    }
